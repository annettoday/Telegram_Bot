...
from sync import DadataClient, CleanClient, ProfileClient, SuggestClient
from dadata import Dadata #в async.py

token = "d6c4e6cc7f93ad1ff6b8e8c76528d501135eb7ec" #в async.py
secret= "3c7f48a0ea37f0082c4a2d77a5a0e7b60ef3d642" #в async.py
dadata = Dadata(token) #в async.py
dadata = DadataClient(token, secret="secret") #в async.py
...
#Функция в async.py
def find_by_id(id):
    result = dadata.find_by_id("party", id)
    return str(result)
