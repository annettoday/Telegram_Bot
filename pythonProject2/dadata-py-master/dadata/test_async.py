...
from asynchr import DadataClient, CleanClient, ProfileClient, SuggestClient
from dadata import Dadata #Помещено в bot.py

token = "d6c4e6cc7f93ad1ff6b8e8c76528d501135eb7ec" #Помещено в bot.py
secret= "3c7f48a0ea37f0082c4a2d77a5a0e7b60ef3d642" #Помещено в bot.py
dadata = Dadata(token)
